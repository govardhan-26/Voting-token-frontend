        ...
        <div className="flex-1 pl-3">
          <div className="flex-1">
            <ul className="pt-2 pb-4 space-y-1 text-sm">
              ...
              <li className="rounded-sm">
                <Link to='/voter_Dashboard/votenow' className="flex items-center p-2 space-x-3 rounded-md">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <li className="rounded-sm">
                <Link to='/voter_dashboard/Results' className="flex items-center p-2 space-x-3 rounded-md">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
