        ...
        <div className="relative bg-white bg-cover m-0 h-[100vh] w-[100vw] flex flex-col items-center justify-center">
            ...
            <div className="relative flex flex-col h-[90%] w-[35%] ">
                <div className='w-full h-[10%] text-center'>      
                    <h1 className='absolute top-[80px] text-[20px] left-[10rem] font-light font-serif '>Admin Login</h1>
                </div>
                <div className="h-[25%] w-full flex flex-row justify-evenly items-center relative">
                    <div className="m-[10px] rounded-[50%] flex items-center justify-center absolute top-[4rem] w-[130px] left-[40px]">
                        <Link to='/voter_login' className=' w-[100px] rounded-full hover:shadow-[0_3px_10px_rgb(0,0,0,0.2)]'><img src={voter_admin} alt="Voter"/></Link>
                    </div>
                    <div className="m-[10px] rounded-[50%] flex items-center justify-center absolute top-[4rem] w-[130px] right-[100px]">
                        <Link to='/admin_login' className='w-[100px] rounded-full hover:shadow-[0_3px_10px_rgb(0,0,0,0.2)]'><img src={login_admin} alt="Admin"/></Link>
                    </div>
                </div>
                ...
                <form action="" className="flex flex-col justify-between m-[2rem] mt-0 font-serif" onSubmit={Register}>
                    ...
                    <button className="w-[85%] p-3 m-8 pl-0 ml-0 rounded-[10rem] text-white bg-[#6268EA]" onClick={Register}>Login</button>
                    <p className='text-center absolute top-[17rem] left-[13rem] pt-1 '>OR</p>
                    <button className='m-2 p-2 gap-2 mt-4 rounded-[10rem] w-[20rem] justify-center items-center flex border'>
                    <FcGoogle/>Login with Google
                    </button>
                    <p className='text-[13px] absolute left-[9rem] top-[22rem] gap-2 mt-3 mx-auto  '>Dont have an account? <a href='/admin_register' className='underline text-[#6268EA]'>Sign Up</a></p>
